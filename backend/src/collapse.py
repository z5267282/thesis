...
def collapse(line_graph: list[Line], program: OrderedDict[int, str],
             root: BodyBlock) -> tuple[list[str], list[int | None], list[int]]:
...
def parse_blank(line: int, line_mapping: dict[int, Block]) -> str:
